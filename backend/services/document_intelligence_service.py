...
from backend.services.datasheet_repair_service import DatasheetRepairService, merge_datasheet_repair
...
class DocumentIntelligenceService:
    def __init__(
        ...
        *,
        ...
        self.repair_service = DatasheetRepairService(
    ...
    def build_from_payload(self, doc_name: str, chunks: list[str], metadata: list[dict]) -> dict:
        ...
        return self.repair_service.repair_if_needed(doc_name, chunks, metadata, intelligence)
