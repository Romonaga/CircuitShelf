...
- Use `assistant mode` via `Documentation/guides/VERLYN_ASSISTANT_STARTUP.md`, then `Documentation/guides/VERLYN_AGENT_WORKFLOW.md`, for assistant-driven sessions inside the target repo.
