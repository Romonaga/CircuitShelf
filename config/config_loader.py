...
class Config:
    REQUIRED_KEYS = [
        ...
        "TRAINING_DIR", "INDEX_FILE", "CHUNKS_FILE", "SOURCES_FILE",
        "METADATA_FILE", "EMBEDDINGS_FILE", "IMAGE_STORE_FILE",
        "IMAGE_CAPTIONS_FILE", "IMAGE_PAGE_TEXT_FILE", "IMAGE_EMBEDDINGS_FILE",
        "IMAGE_IDS_FILE", "TRAINING_OUTPUT_FILE", "BUILD_INDEX_LOG_FILE",
        "CACHE_FILE", "DOC_EXT", "PDF_EXT", "MD_EXT", "IMG_EXTENSIONS",
