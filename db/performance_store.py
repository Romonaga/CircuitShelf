...
class PerformanceStore:
            ...
            with self.database.connection() as conn:
                conn.execute(
                    ...
                    (
                        ...
                        self._optional_int(worker_budget.get("documentWorkerCapacity")) or 0,
    ...
    def _sample_row(row: dict[str, Any]) -> dict[str, Any]:
        return {
            ...
            "workerCapacity": PerformanceStore._optional_int(row.get("active_document_worker_capacity")) or 0,
