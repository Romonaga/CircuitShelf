...
SETTING_UI = {
    ...
    "LOCAL_GPU_OCR_SLOTS": ("models", "OCR CUDA lanes", "PaddleOCR CUDA work lanes. Auto sizes from detected GPU count and VRAM; explicit values can be used for tuning.", False),
