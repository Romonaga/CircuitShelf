...
SETTING_UI = {
    ...
    "PADDLEOCR_USE_GPU": ("ocr", "PaddleOCR GPU request", "Request PaddleOCR GPU inference when OCR_ENGINE is paddleocr. Requires the experimental GPU gate.", False),
    "PADDLEOCR_GPU_EXPERIMENTAL_ENABLED": ("ocr", "Experimental GPU OCR", "Allow PaddleOCR to use CUDA. Keep off unless actively testing GPU OCR stability.", False),
    "PADDLEOCR_DEVICE": ("ocr", "PaddleOCR device", "PaddleOCR device hint. GPU is ignored unless experimental GPU OCR is enabled.", False),
