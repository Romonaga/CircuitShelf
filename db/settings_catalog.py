...
SETTING_UI = {
    ...
    "LOCAL_GPU_OCR_SLOTS": ("models", "OCR CUDA lanes", "PaddleOCR CUDA work lanes. Auto uses a conservative per-GPU lane count; explicit values can be used for tuning.", False),
