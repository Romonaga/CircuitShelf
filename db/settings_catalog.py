...
SETTING_UI = {
    ...
    "OCR_ENGINE": ("ocr", "OCR engine", "OCR engine used during ingestion. Use Tesseract for stable CPU OCR or PaddleOCR for selectable CPU/GPU OCR testing.", False),
    ...
    "PADDLEOCR_DEVICE": ("ocr", "PaddleOCR compute device", "Used only when OCR engine is PaddleOCR. CPU is safer; GPU is experimental and can be faster on image-heavy documents.", False),
